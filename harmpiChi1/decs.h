...
#define OUTER_R  (1000)       /* YOAV: outer radius of simulation*/
...
#define PERIODIC (0)          /* whether or not to use periodic boundary conditions */
#define OUTFLOW  (0)          /* whether or not to use outflow boundary conditions in all directions */
#define WIND     (1)          /* YOAV: whether or not to use wind boundary condition of acceration disk*/
#define BL_A     (0.9375)     /* YOAV: defined a=J/Mc ratio of BH*/
#define D_RIN    (10.0)       /* YOAV: inner disk radius*/
#define D_ROUT   (200.0)      /* YOAV: outer disk radius*/
#define FOCAL_Z  (500.0)      /* YOAV: z location of wind streamlines focal point*/
#define OUTER_R  (1000.0)     /* YOAV: outer radius of simulation*/
#define BERN_W   (1.89428)    /* YOAV: dimensionless Bernoulli function */
#define LUMN_W   (0.002)     /* YOAV: Wind luminosity */
#define PRES_W   (1e-10)      /* YOAV: Wind initial pressure */
